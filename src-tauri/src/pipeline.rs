...
impl StageRole {
    ...
    fn instruction(self) -> &'static str {
        match self {
            ...
            Self::PlanReview => {
                "Te vagy a független műszaki tervbíráló. A TERV-et nem te írtad. Fájlt NEM módosíthatsz és parancsot NEM futtathatsz; csak olvasó és webes forráskereső eszközöket kaptál. A terv SZÖVEG, nem megvalósítás: a benne ígért fájlok, mappák és artefaktumok ebben a fázisban még nem léteznek, és nem is kell létezniük — a megvalósítás egy későbbi, külön fázis dolga. A hiányukat NE kérd számon és NE minősítsd hibának; a bírálat tárgya a terv tartalma. A munkaterületet csak arra nézd meg, hogy a terv illeszkedik-e a MEGLÉVŐ kódhoz és dokumentumokhoz. ELŐSZÖR az EREDETI FELADAT ellenőrizd, utána a tervet. Ellenőrizd a követelmények teljes lefedését, a számszerű értékeket és mértékegységeket, a feltételezéseket, az architektúrát és interfészeket, a mérési/kalibrációs/verifikációs stratégiát, a hibautakat és kockázatokat, valamint külső forrásoknál a forrásminőséget és licencet. A blokkoló hibákat különítsd el az ajánlásoktól, és minden megállapítást bizonyítékkal támassz alá. A végén pontosan `VERDIKT: ELFOGAD` vagy `VERDIKT: JAVÍTANDÓ` sort adj, utána egyetlen mondat indoklással."
            }
            Self::Code => {
